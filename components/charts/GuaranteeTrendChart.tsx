...
import { GuaranteeTrendData, MonthGuaranteeTrend } from '@/types/dashboard';
...
export function GuaranteeTrendChart({
  data,
  title = 'Tendencia de Cartera de Garantías',
  className,
  ...
  // Table columns
  const columns = [
    { key: 'providerName', label: 'Proveedor', sortable: true, width: '30%' },
    { key: 'onTime', label: 'En Tiempo', sortable: true, align: 'right' as const, format: 'currency' as const, width: '20%' },
    { key: 'overdue', label: 'Vencido', sortable: true, align: 'right' as const, format: 'currency' as const, width: '20%' },
    { key: 'total', label: 'Total', sortable: true, align: 'right' as const, format: 'currency' as const, width: '20%' },
    { key: 'branch', label: 'Sucursal', sortable: true, width: '10%' },
  ];
  ...
  return (
    <Card className={className}>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-label-medium text-on-surface-variant">Cartera Promedio</p>
      ...
      <CardContent>
        ...
        >
          {showTable ? 'Ocultar Detalle' : 'Ver Detalle por Proveedor'}
        </button>
        ...
        {showTable && (
          <div className="mt-4">
            <DataTable
              ...
              columns={columns}
              title="Detalle de Garantías por Proveedor"
              sortable
